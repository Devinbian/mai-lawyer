...
function getCommonImages(types) {
  const baseImagePath = "https://minio.maixiaolv.com/mxl/images";
  ...
  const imageConfigs = {
    ...
    default: {
      ...
      successNotice: getImageByPixelRatio(`${baseImagePath}/profile/success-notice`),
      errorNotice: getImageByPixelRatio(`${baseImagePath}/profile/error-notice`),
      couponNotice: getImageByPixelRatio(`${baseImagePath}/profile/coupon-notice`),
      defaultNotice: getImageByPixelRatio(`${baseImagePath}/profile/default-notice`),
      alertNotice: getImageByPixelRatio(`${baseImagePath}/profile/alert-notice`),
      alertInfo: getImageByPixelRatio(`${baseImagePath}/profile/alert-info`),
      successInfo: getImageByPixelRatio(`${baseImagePath}/profile/success-info`),
    },
  };
